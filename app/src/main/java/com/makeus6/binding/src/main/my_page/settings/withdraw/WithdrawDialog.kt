package com.makeus6.binding.src.main.my_page.settings.withdraw
...
class WithdrawDialog(@NonNull mContext: Context,
                     private val confirm: View.OnClickListener,
                     private val cancel: View.OnClickListener
                     ): Dialog(mContext) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 버튼 이벤트
        val btnCancel: Button = findViewById(R.id.dialog_withdraw_no)
        val btnWithdraw: Button = findViewById(R.id.dialog_withdraw_yes)

        btnCancel.setOnClickListener(cancel)
        btnWithdraw.setOnClickListener(confirm)
    }
}